...
/**
 * A class to animate a runner
 */
public class MovingRunner extends Runner implements Animatable {
     ...
     *
     * @param x         the initial x coordinate of the runner
     * @param y         the initial y coordinate of the runner
